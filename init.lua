...
vim.o.number = true
-- Together with relative line numbers
...
-- Set tab to 4 spaces by default
vim.o.tabstop = 4
vim.o.shiftwidth = 4
...
-- EOF + Normal mode
vim.keymap.set("t", "<C-d><C-n>", "<C-\\><C-n>", { desc = "Exit terminal mode" })
  ...
  --]]
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>si", builtin.diagnostics, { desc = "[S]earch [I]ssues" })
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("gA", require("telescope.builtin").lsp_document_symbols, "Open [A]ll symbols in buffer")
				end,
			})
	...
	{ -- Collection of various small independent plugins/modules
		...
		config = function()
			...
			-- Toggle comment on parts of a buffer (using gc)
			--
			-- - gcc - Toggle comment on line
			-- - gc} - Comment paragraph
	...
	-- FUTURE: Config modularisation (when needed)
	-- { import = "custom.plugins" },
	--
	-- For additional information with loading, sourcing and examples see `:help lazy.nvim-🔌-plugin-spec`
	-- Use telescope!
	{ -- EasyMotion-like plugin for neovim, without Lsp issues
		"smoka7/hop.nvim",
		version = "*",
		opts = {},
